(define *capabilities* (make-symbol-table))
    ...
    ((_ name type index)
     (begin (table-set! *capabilities* 
                        ...
                        (cons (case 'type
                              ...
                              index))
            (define (name) (terminfo-capability *terminfo* 'name))))))
...
(define-capability newline string 103)
